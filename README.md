...
| 파트 | 담당 영역 | 브랜치 |
| --- | --- | --- |
| A | 공통 Phaser·진행도·통합 | `feat/stage-1/10320` |
| B | 외부·입구·중앙 복도 | `feat/stage-1/10404` |
| C | 연구 자료실 | `feat/stage-1/10409` |
| D | 과학 실험실 | `feat/stage-1/10514` |
...
```text
feat/stage-1/학번 → develop/stage-1 → main
```
