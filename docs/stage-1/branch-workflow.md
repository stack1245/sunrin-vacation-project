...
>
> 공통 기준: A 파트 `feat/stage-1-10320-core`
...
```text
develop/stage-1
  └─ feat/stage-1-10320-core  ← 공통 프로젝트·Phaser 기반
       ├─ feat/stage-1-10404-outside-hallway
       ├─ feat/stage-1-10409-research-archive
       ├─ feat/stage-1-10514-science-lab
       ├─ feat/stage-1-10602-control-room
       └─ feat/stage-1-10405-document-storage
```
...
| --- | --- | --- | --- | --- |
| A | 10320 탁도형 | 공통 Phaser, Room 계약, 진행도·저장, HUD, 통합 주도 | `feat/stage-1-10320-core` | `github/feat/stage-1-10320-core` |
| B | 10404 김준서 | 연구소 외부, 입구, 중앙 복도, 키카드, 최종 탈출 | `feat/stage-1-10404-outside-hallway` | `github/feat/stage-1-10404-outside-hallway` |
| C | 10409 서정권 | 연구 자료실, 카이사르·비즈네르 암호, 실험실 단서 | `feat/stage-1-10409-research-archive` | `github/feat/stage-1-10409-research-archive` |
| D | 10514 이동혁 | 과학 실험실, 화학·밀도·산소·점화·가열 퍼즐 | `feat/stage-1-10514-science-lab` | `github/feat/stage-1-10514-science-lab` |
| E | 10602 김보민 | 보안 통제실, 가상 F12·Cookie·Console·OTP | `feat/stage-1-10602-control-room` | `github/feat/stage-1-10602-control-room` |
| F | 10405 김지산 | 문서 보관실, hello world·스도쿠·N-Queens·자원 분배·기밀 문서 | `feat/stage-1-10405-document-storage` | `github/feat/stage-1-10405-document-storage` |
